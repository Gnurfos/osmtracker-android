...
import com.nastybit.osmtracker.view.DisplayTrackView;
			...
			dtv.post(new Runnable() {
				...
				public void run() {
					new AlertDialog.Builder(DisplayTrack.this)
						.setTitle(com.nastybit.osmtracker.R.string.prefs_displaytrack_osm)
						.setMessage(com.nastybit.osmtracker.R.string.prefs_displaytrack_osm_summary_ask)
						.setNegativeButton(android.R.string.no, null)
						.setPositiveButton(com.nastybit.osmtracker.R.string.displaytrack_map, new DialogInterface.OnClickListener() {
							@Override
